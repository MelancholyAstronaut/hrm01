...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td width="15" height="32"><img src="${pageContext.request.contextPath}/images/main_locleft.gif" width="15"
                                        height="32"></td>
        <td class="main_locbg font2"><img src="${pageContext.request.contextPath}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：部门管理
            &gt; 部门查询
        </td>
                ...
                <tr>
                    <td class="fftd">
                        <form name="deptform" method="post" id="deptform"
                              action="${pageContext.request.contextPath}/dept/showAll">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">
                                        部门名称：<input type="text" name="name" value="${deptInf.name}">
        ...
        <td height="20">
            <table width="100%" border="1" cellpadding="5" cellspacing="0"
                ...
                <c:forEach items="${deptList}" var="dept" varStatus="stat">
                    <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);"
                        ...
                        <td>${dept.name }</td>
                        <td>${dept.remark }</td>
                        <td align="center" width="40px;"><a href="/dept/showUpdate/${dept.id}">
            ...
            <div align="center">
                ...
                <ul class="pager">
                    ...
                    <li>
                        <a href="/dept/showAll/?pageNum=${page.prePage}&name=${deptInf.name}">上一页</a>
                    </li>
                    <li>
                        <a href="/dept/showAll/?pageNum=${page.nextPage}&name=${deptInf.name}">下一页</a>
                    </li>
                    <li>
                        <a href="/dept/showAll/?pageNum=${page.navigateLastPage}&name=${deptInf.name}">尾页</a>
                    </li>
                </ul>
            </div>
