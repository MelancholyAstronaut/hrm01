...
) ENGINE = InnoDB AUTO_INCREMENT = 1702 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `personallearn`  (
  ...
  CONSTRAINT `coursename_fk` FOREIGN KEY (`coursename`) REFERENCES `course` (`name`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ...
  CONSTRAINT `studentid_fk` FOREIGN KEY (`studentid`) REFERENCES `student` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `studentname_fk` FOREIGN KEY (`studentname`) REFERENCES `student` (`name`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- ----------------------------
INSERT INTO `personallearn` VALUES (1, 'zhangsan', 'male', '17java1', '计算机网络', 98, 1, 98);
INSERT INTO `personallearn` VALUES (2, 'lisi', 'male', '17java2', '毛中特', 56, 98, 60);
INSERT INTO `personallearn` VALUES (3, 'wangwu', 'male', '17java1', '计算机网络', 80, 80, 80);
INSERT INTO `personallearn` VALUES (4, 'mali', 'female', '17java1', '计算机网络', 60, 60, 60);
INSERT INTO `personallearn` VALUES (5, 'tom', 'male', '17java2', '毛中特', 77, 77, 77);
INSERT INTO `personallearn` VALUES (6, 'cat', 'male', '17java2', '毛中特', 78, 78, 78);
INSERT INTO `personallearn` VALUES (7, 'lily', 'female', '17java3', 'Oracle数据库', 66, 66, 66);
INSERT INTO `personallearn` VALUES (8, 'monica', 'female', '17java3', 'Oracle数据库', 98, 98, 98);
INSERT INTO `personallearn` VALUES (9, 'luosi', 'male', '17java3', 'Oracle数据库', 84, 84, 84);
INSERT INTO `personallearn` VALUES (10, 'joe', 'male', '17java4', '企业项目实战', 69, 69, 69);
INSERT INTO `personallearn` VALUES (11, 'ruiqiu', 'female', '17java4', '企业项目实战', 82, 82, 82);
INSERT INTO `personallearn` VALUES (12, 'feibi', 'female', '17java4', '企业项目实战', 99, 99, 99);
