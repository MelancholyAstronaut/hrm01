...
<%--
  ...
  User: Hao
        ...
        function tianjia()
        {
            ...
            {
                alert("确定添加！");
                window.location.href = "${pageContext.request.contextPath}/newsLabel/addLabel";
            }
            else
            {
                alert("取消添加！");
...
<center>
    ...
    <form name="form1" method="post" action="${pageContext.request.contextPath}/newsLabel/addLabel">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
            ...
            <tr>
                ...
                <td width="86%" class="td_02">
                    <input name="label_name" type="text" class="input" style="width:99% "></td>
            </tr>
            <tr>
